...
<?php if (!$files): ?>
    <div class="bg-white rounded-lg shadow-sm border border-slate-200 panel-empty">
        <p>Kütüphanede henüz görsel yok. JPEG, PNG, WebP veya GIF yükleyin; yazı ve sayfalarda bu dosyaları kullanabilirsiniz.</p>
    </div>
<?php else: ?>
